...
if ( $_FILES ) {
	...
	move_uploaded_file ($_FILES['numbers']['tmp_name'] , 'temp/'.$_FILES['numbers']['name'].'.txt' );
//die;
	$numbers = file_get_contents('temp/'.$_FILES['numbers']['name'].'.txt');
	...
	echo "<h1>Total Numbers:".count($numbers)."</h1>";
