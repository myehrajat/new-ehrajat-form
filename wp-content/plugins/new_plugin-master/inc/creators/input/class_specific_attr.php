...
class attr_validation extends common {
    ...
    **/
    ...
    function attr_tabindex( $attr_value ) {
        return $this->create_numeric_attribute( 'tabindex', $attr_value );
    }
    ...
    ********************************************/
    ...
    function attr_maxlength( $attr_value ) {
        return $this->create_numeric_attribute( 'maxlength', $attr_value );
    }
    ...
    function attr_minlength( $attr_value ) {
        return $this->create_numeric_attribute( 'minlength', $attr_value );
    }
    ...
    function attr_size( $attr_value ) {
        return $this->create_numeric_attribute( 'size', $attr_value );
    }
    //
...
class common_attr extends attr {
    ...
    function create_attr_input_common() {
        ...
        $common = $this->create_multiple_attrs( array(
            ...
            'type' => $this->input_type_obj->html_type,
...
class specific_attr extends attr {
    ...
    function __construct( $attr_input_specific_id = NULL, $input_type = NULL ) {
        ...
        $this->specific_attr = $this->create_attr_input_specific();
    }
    ...
    function __construct( $input_id = NULL ) {
        ...
        if ( !empty( $this->input_id ) ) {
            ...
            if ( !empty( $this->input_obj ) ) {
                ...
                $this->specific_attr_obj = new specific_attr( $this->specific_attr_id, $this->common_attr_obj->input_html_type );
