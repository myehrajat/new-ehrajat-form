...
function bootstrap4_persian_datetime_scripts() {
	wp_register_script('jquery.md.bootstrap.datetimepicker.js', plugins_url('MD.BootstrapPersianDateTimePicker-master-bs4/src/jquery.md.bootstrap.datetimepicker.js', __FILE__), array('jquery'),'1.1', true);
