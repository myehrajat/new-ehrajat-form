...
/*global $wpdb;
foreach ( $n as $ostan => $n_ids ) {
	foreach($n_ids as $kode_meli_prefix=>$shahr  ){
		$wpdb->query("INSERT INTO kode_meli_prefix(ostan,shahr,kode_meli_prefix) VALUES ('".$ostan."','".$shahr."',".$kode_meli_prefix.");");
	}
}
*/
