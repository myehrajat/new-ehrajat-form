...
-- ----------------------------
-- Table structure for wp_tt_field
-- ----------------------------
DROP TABLE IF EXISTS `wp_tt_field`;
CREATE TABLE `wp_tt_field`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `epithet` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `user_access_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
-- ----------------------------
-- Records of wp_tt_field
-- ----------------------------
INSERT INTO `wp_tt_field` VALUES (1, '', '', '1-2', '24', '1', '', NULL, '2019-11-08 16:54:59', '2019-11-08 16:54:59');
...
-- ----------------------------
INSERT INTO `wp_tt_input` VALUES (1, 'Test Text Input', 'test-text', '1', '', 'form_id', 'textfield', '1', 'Value Data', '%%E%%return \'1\';', '%%E%%return \'1\';', '', NULL, 'Myehrajat', '2019-09-17 05:38:00', '2019-09-17 05:38:00');
...
-- ----------------------------
INSERT INTO `wp_tt_tags` VALUES (1, 'Test Text Input', '', '<label for=\"{{id}}\">sample label<label>', '', '', NULL, '2019-11-06 08:13:34', '2019-11-06 08:13:34');
INSERT INTO `wp_tt_tags` VALUES (2, 'Test Search Input', '', '<label for=\"{{id}}\">sample field<label>', 'Test Search Input', '', NULL, '2019-11-06 16:23:50', '2019-11-06 16:23:50');
INSERT INTO `wp_tt_tags` VALUES (3, 'Test Tel Input', '', 'Test Tel Input', 'Test Tel Input', '', NULL, '2019-11-06 16:23:51', '2019-11-06 16:23:51');
INSERT INTO `wp_tt_tags` VALUES (4, 'Test URL Input', '', 'Test URL Input', 'Test URL Input', '', NULL, '2019-11-06 16:23:52', '2019-11-06 16:23:52');
INSERT INTO `wp_tt_tags` VALUES (5, 'Test Submit Input', '', 'Test Submit Input', 'Test Submit Input', '', NULL, '2019-11-06 16:23:52', '2019-11-06 16:23:52');
INSERT INTO `wp_tt_tags` VALUES (6, 'Test Range Input', '', 'Test Range Input', 'Test Range Input', '', NULL, '2019-11-06 16:23:53', '2019-11-06 16:23:53');
INSERT INTO `wp_tt_tags` VALUES (7, 'Password Input', '', 'Password Input', 'Password Input', '', NULL, '2019-11-06 16:23:54', '2019-11-06 16:23:54');
INSERT INTO `wp_tt_tags` VALUES (8, 'Number Input', '', 'Number Input', 'Number Input', '', NULL, '2019-11-06 16:23:54', '2019-11-06 16:23:54');
INSERT INTO `wp_tt_tags` VALUES (9, 'Image Input', '', 'Image Input', 'Image Input', '', NULL, '2019-11-06 16:23:55', '2019-11-06 16:23:55');
INSERT INTO `wp_tt_tags` VALUES (10, 'File Input', '', 'File Input', 'File Input', '', NULL, '2019-11-06 16:23:55', '2019-11-06 16:23:55');
INSERT INTO `wp_tt_tags` VALUES (11, 'Email Input', '', 'Email Input', 'Email Input', '', NULL, '2019-11-06 16:24:01', '2019-11-06 16:24:01');
INSERT INTO `wp_tt_tags` VALUES (12, 'Date Input', '', 'Date Input', 'Date Input', '', NULL, '2019-11-06 16:24:02', '2019-11-06 16:24:02');
INSERT INTO `wp_tt_tags` VALUES (13, 'Datetime-local Input', '', 'Datetime-local Input', 'Datetime-local Input', '', NULL, '2019-11-06 16:24:05', '2019-11-06 16:24:05');
INSERT INTO `wp_tt_tags` VALUES (14, 'Month Input', '', 'Month Input', 'Month Input', '', NULL, '2019-11-06 16:24:07', '2019-11-06 16:24:07');
INSERT INTO `wp_tt_tags` VALUES (15, 'Time Input', '', 'Time Input', 'Time Input', '', NULL, '2019-11-06 16:24:10', '2019-11-06 16:24:10');
INSERT INTO `wp_tt_tags` VALUES (16, 'Week Input', '', 'Week Input', 'Week Input', '', NULL, '2019-11-06 16:24:17', '2019-11-06 16:24:17');
INSERT INTO `wp_tt_tags` VALUES (17, 'Datetime Input', '', 'Datetime Input', 'Datetime Input', '', NULL, '2019-11-06 16:24:23', '2019-11-06 16:24:23');
INSERT INTO `wp_tt_tags` VALUES (18, 'Color Input', '', 'Color Input', 'Color Input', '', NULL, '2019-11-06 16:24:29', '2019-11-06 16:24:29');
INSERT INTO `wp_tt_tags` VALUES (19, 'Checkbox Input', '', 'Checkbox Input', 'Checkbox Input', '', NULL, '2019-11-06 16:24:36', '2019-11-06 16:24:36');
INSERT INTO `wp_tt_tags` VALUES (20, 'Radio Input', '', 'Radio Input', 'Radio Input', '', NULL, '2019-11-06 16:24:40', '2019-11-06 16:24:40');
INSERT INTO `wp_tt_tags` VALUES (21, 'Hidden Input', '', 'Hidden Input', 'Hidden Input', '', NULL, '2019-11-06 16:24:41', '2019-11-06 16:24:41');
INSERT INTO `wp_tt_tags` VALUES (22, 'Select Input', '', 'Select Input', 'Select Input', '', NULL, '2019-11-06 16:24:46', '2019-11-06 16:24:46');
INSERT INTO `wp_tt_tags` VALUES (23, 'Textarea Input', '', 'Textarea Input', 'Textarea Input', '', NULL, '2019-11-06 16:24:49', '2019-11-06 16:24:49');
INSERT INTO `wp_tt_tags` VALUES (24, '', '', 'FIELD ', 'FIELD ', '', NULL, '2019-11-11 15:18:46', '2019-11-11 15:18:46');
...
CREATE TABLE `wp_tt_user_access`  (
  ...
  `epithet` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `slug` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `default_show_or_hide` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `except_show_or_hide` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `default_enable_or_disable` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `except_enable_or_disable` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `description` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `owner` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `created` datetime(0) NOT NULL DEFAULT current_timestamp(0),
  `modified` datetime(0) NOT NULL DEFAULT current_timestamp(0),
...
-- ----------------------------
INSERT INTO `wp_tt_user_access` VALUES (1, '', '', 'show', '2', 'enable', '2', '', NULL, '2019-11-08 16:56:29', '2019-11-08 16:56:29');
